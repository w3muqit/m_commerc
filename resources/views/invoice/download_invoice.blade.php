...
<!-- Mirrored from invoma.vercel.app/general_10.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Apr 2023 17:53:46 GMT -->
        ...
        <div class="tm_invoice_in">
          ...
          <div class="tm_invoice_info tm_mb20">
            ...
            <div class="tm_invoice_info_list">
              <p class="tm_invoice_number tm_m0">Invoice No: <b class="tm_primary_color">{{ $data->order_id }}</b></p>
              <p class="tm_invoice_date tm_m0">Date: <b class="tm_primary_color">{{ $data->created_at->format('Y-m-d') }}</b></p>
          ...
          <div class="tm_invoice_head tm_mb10">
            <div class="tm_invoice_left">
              ...
              <p>{{ $customer_info->first()->name }}<br>
                {{ $customer_info->first()->address }} <br>{{ $customer_info->first()->rel_to_country->name }} <br>
                {{ $customer_info->first()->email }}
              </p>
            </div>
            <div class="tm_invoice_right tm_text_right">
              ...
              <table class="tm_border_bottom">
                <thead>
                  <tr class="tm_border_top">
                    <th class="tm_width_3 tm_semi_bold tm_primary_color tm_accent_bg_10">Sl</th>
                    <th class="tm_width_3 tm_semi_bold tm_primary_color tm_accent_bg_10">Item Name</th>
                    ...
                    <th class="tm_width_2 tm_semi_bold tm_primary_color tm_accent_bg_10 tm_text_right"> Sub Total</th>
                  </tr>
                </thead>
                <tbody>
                    @php
                        $sub_total=0;
                    @endphp
                    @foreach ( $order_info  as $sl=> $oredr_delails )
                  <tr>
                    <td>{{ $sl+1 }}</td>
                    <td class="tm_width_3">{{ $oredr_delails->rel_to_pro->product_name }}</td>
                    <td class="tm_width_2">{{ $oredr_delails->price }}</td>
                    <td class="tm_width_1">{{ $oredr_delails->quantity }}</td>
                    <td class="tm_width_2 tm_text_right">{{ $oredr_delails->price*$oredr_delails->quantity }}</td>
                  </tr>
                  @php
                      $sub_total +=$oredr_delails->price*$oredr_delails->quantity+$data->charge
                  @endphp
                  @endforeach
                </tbody>
              </table>
                ...
                <table>
                  <tbody>
                    <tr>
                      ...
                      <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_bold">{{ $sub_total  }}</td>
                    </tr>
                    <tr>
                      <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">Charge <span class="tm_ternary_color"></span></td>
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color tm_text_right">{{ $data->charge }}</td>
                    </tr>
                    <tr class="tm_border_top tm_border_bottom">
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color">Discount	</td>
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color tm_text_right">{{ $data->discount }}</td>
                    </tr>
                    <tr class="tm_border_top tm_border_bottom">
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color">Grand Total	</td>
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_primary_color tm_text_right">{{ $sub_total+$data->charge-$data->discount }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
...
<!-- Mirrored from invoma.vercel.app/general_10.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Apr 2023 17:53:47 GMT -->
</html>
