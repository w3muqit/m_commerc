						...
						<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="currency-selector dropdown js-dropdown float-right mr-3">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  ...
                                  <a class="dropdown-item" href="{{ route('customer.logout') }}">Loguot</a>
                                </div>
                              </div>
							</div>
                            ...
                            @else
                            <div class="currency-selector dropdown js-dropdown float-right mr-3">
								<a href="{{ route('customer') }}" class="text-muted medium"><i class="lni lni-user mr-1"></i>Sign In / Register</a>
							</div>
                            @endauth
						</div>
							...
							<div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									<div class="cart_selected_single_thumb">
										<a href="#"><img src="{{ asset('upload/product/preview') }}/{{ $wishlist->rel_to_wish->preview }}" width="60" class="img-fluid" alt="" /></a>
									</div>
									<div class="cart_single_caption pl-2">
										<h4 class="product_title fs-sm ft-medium mb-0 lh-1">{{ $wishlist->rel_to_wish->product_name }}</h4>
									</div>
								</div>
					...
					<div class="right-ch-sideBar">
						...
						<div class="cart_select_items py-2">
							...
							<div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									<div class="cart_selected_single_thumb">
										<a href="#"><img src="{{ asset('upload/product/preview') }}/{{ $cart_items->rel_to_pro->preview }}" width="60" class="img-fluid" alt="" /></a>
									</div>
									<div class="cart_single_caption pl-2">
										<h4 class="product_title fs-sm ft-medium mb-0 lh-1">{{ $cart_items->rel_to_pro->product_name }}</h4>
										<p class="mb-2"><span class="text-dark ft-medium small">{{ ($cart_items->size_id == null)?'':$cart_items->rel_to_size->size }}</span>{{ ($cart_items->size_id ==null|$cart_items->color_id == null)?'':',' }}<span class="text-dark small">{{ ($cart_items->color_id == null)?'':$cart_items->rel_to_color->color_name }} </span></p>
										<h4 class="fs-md ft-medium mb-0 lh-1">TK{{ $cart_items->rel_to_pro->after_discount }} X {{ $cart_items->quantity }} </h4>
									</div>
								</div>
