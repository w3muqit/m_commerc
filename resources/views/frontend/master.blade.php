            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                        ...
                        @else
                            <div class="currency-selector dropdown js-dropdown float-right mr-3">
                                <a href="{{ route('customer') }}" class="text-muted medium"><i
                            ...
                            <div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                                <div class="cart_single d-flex align-items-center">
                                    <div class="cart_selected_single_thumb">
                                        <a href="#"><img
                                                src="{{ asset('upload/product/preview') }}/{{ $wishlist->rel_to_wish->preview }}"
                                                width="60" class="img-fluid" alt="" /></a>
                                    </div>
                                    <div class="cart_single_caption pl-2">
                                        <h4 class="product_title fs-sm ft-medium mb-0 lh-1">
                                            {{ $wishlist->rel_to_wish->product_name }}</h4>
                                    </div>
                                </div>
        ...
        <div class="w3-ch-sideBar w3-bar-block w3-card-2 w3-animate-right" style="display:none;right:0;"
            ...
            <div class="rightMenu-scroll">
                ...
                <div class="right-ch-sideBar">
                        ...
                        @foreach (App\Models\Cart::where('customer_id', Auth::guard('customerlogin')->id())->get() as $cart_items)
                            <div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                                <div class="cart_single d-flex align-items-center">
                                    <div class="cart_selected_single_thumb">
                                        <a href="#"><img
                                                src="{{ asset('upload/product/preview') }}/{{ $cart_items->rel_to_pro->preview }}"
                                                width="60" class="img-fluid" alt="" /></a>
                                    </div>
                                    <div class="cart_single_caption pl-2">
                                        <h4 class="product_title fs-sm ft-medium mb-0 lh-1">
                                            {{ $cart_items->rel_to_pro->product_name }}</h4>
                                        <p class="mb-2"><span
                                                class="text-dark ft-medium small">{{ $cart_items->size_id == null ? '' : $cart_items->rel_to_size->size }}</span>{{ ($cart_items->size_id == null) | ($cart_items->color_id == null) ? '' : ',' }}<span
                                                class="text-dark small">{{ $cart_items->color_id == null ? '' : $cart_items->rel_to_color->color_name }}
                                            </span></p>
                                        <h4 class="fs-md ft-medium mb-0 lh-1">
                                            TK{{ $cart_items->rel_to_pro->after_discount }} X
                                            {{ $cart_items->quantity }} </h4>
                                    </div>
                                </div>
                                <div class="fls_last"><a href="{{ route('cart.remove', $cart_items->id) }}"
                                        class="close_slide gray"><i class="ti-close"></i></a></div>
                            </div>
                            @php
                    ...
                    <div class="cart_action px-3 py-3">
                        <div class="form-group">
                            <a href="{{ route('view.cart') }}" class="btn d-block full-width btn-dark-light">View
                                Cart</a>
                        </div>
                    </div>
