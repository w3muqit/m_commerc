                ...
                <div class="d-block border rounded">
                    ...
                    <div class="dashboard_author">
                        ...
                        <ul class="dahs_navbar">
                            <li><a href="{{ route('customer.status') }}"><i class="lni lni-shopping-basket mr-2"></i>My Order</a></li>
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-5 col-12">
                                <div class="cart_single d-flex align-items-start mfliud-bot">
                                    <div class="cart_selected_single_thumb">
                                        <a href="#"><img src="{{  asset('upload/product/preview')  }}/{{ $order->rel_to_pro->preview }}" width="75" class="img-fluid rounded" alt=""></a>

                                    </div>
                                    <div class="cart_single_caption pl-3">
                                        <p class="mb-0"><span class="text-muted small"></span></p>
                                        <h4 class="product_title fs-sm ft-medium mb-1 lh-1">{{ $order->rel_to_pro->product_name }}</h4>
                                        <p class="mb-2"><span class="text-dark medium">Size: {{ $order->rel_to_size->size }}</span>, <span class="text-dark medium">Color: {{ $order->rel_to_color->color_name }}</span></p>
                                        <h4 class="fs-sm ft-bold mb-0 lh-1">{{ $order->rel_to_pro->after_discount }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
